    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_payment_status', models.CharField(choices=[('PAPD', 'پرداخت جزیی'), ('COPD', 'پرداخت کامل'), ('NOPD', 'پرداخت نشده')], default='NOPD', max_length=4, verbose_name='وضعیت تسویه حساب کارفرما')),
                ('personnel_payment_status', models.CharField(choices=[('PAPD', 'پرداخت جزیی'), ('COPD', 'پرداخت کامل'), ('NOPD', 'پرداخت نشده')], default='NOPD', max_length=4, verbose_name='وضعیت تسویه حساب پرسنل')),
